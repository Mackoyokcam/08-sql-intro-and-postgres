...
app.get('/new', function(request, response) {
  ...
  // This is number 5 (response) in the diagram, interacting with the view.
  // No method article.js calls this.
  // This is a READ part of CRUD.
...
app.get('/articles', function(request, response) {
  // COMMENT: DONE What number(s) of the full-stack-diagram.png image correspond to the following line of code? Which method of article.js is interacting with this particular piece of `server.js`? What part of CRUD is being enacted/managed by this particular piece of code?
  // Put your response here...
  // This is number 3(query), 4(result) and 5(response) in the diagram.
  // Article.fetchAll is the method in article.js interacting with this code.
  // This is a READ part of CRUD
...
app.post('/articles', function(request, response) {
  // COMMENT: DONE What number(s) of the full-stack-diagram.png image correspond to the following line of code? Which method of article.js is interacting with this particular piece of `server.js`? What part of CRUD is being enacted/managed by this particular piece of code?
  // Put your response here...
  // This is number 3(query) and 4(result) in the diagram.
  // Article.prototype.insertRecord is the method in article.js interacting with this code.
  // This is a CREATE part of CRUD.
  client.query(
    `INSERT INTO
...
app.put('/articles/:id', function(request, response) {
  // COMMENT: DONE What number(s) of the full-stack-diagram.png image correspond to the following line of code? Which method of article.js is interacting with this particular piece of `server.js`? What part of CRUD is being enacted/managed by this particular piece of code?
  // Put your response here...
  // This is number 3(query) in the diagram.
  // Article.prototype.updateRecord is the method in article.js interacting with this code.
  // This is a UPDATE part of CRUD.
  client.query(
    `UPDATE articles
    SET
...
app.delete('/articles/:id', function(request, response) {
  ...
  // Put your response here...
  // This is number 3(query) and 4(result) in the diagram.
  // Article.prototype.deleteRecord is the method in article.js interacting with this code.
  // This is a DESTROY part of CRUD.
  client.query(
...
app.delete('/articles', function(request, response) {
  ...
  // Put your response here...
  // This is number 3(query) and 4(result) in the diagram.
  // Article.truncateTable is the method in article.js interacting with this code.
  // This is a DELETE part of CRUD.
  client.query(
...
function loadArticles() {
  // COMMENT: DONE What number(s) of the full-stack-diagram.png image correspond to the following line of code? Which method of article.js is interacting with this particular piece of `server.js`? What part of CRUD is being enacted/managed by this particular piece of code?
  // Put your response here...
  // This is either a number 3(query) and 4(result) or 3(query), 4(result), and 3(query) in the diagram, depnding if the first query returns a result with data.
  // No method is the method in article.js interacting with this code.
  // This is a READ, or READ UPDATE if the result returns no data.
...
function loadDB() {
  ...
  // Put your response here...
  // This is number 3(query) in the diagram.
  // No is the method in article.js interacting with this code.
  // This is a CREATE part of CRUD.
  client.query(`
